...
INSERT INTO "new_Pledge" ("createdAt", "funding", "goal", "id", "measurability", "method", "order", "politicianId", "realm", "source", "status", "statusCheckedAt", "statusNote", "statusSource", "timeline", "title", "updatedAt") SELECT "createdAt", "funding", "goal", "id", "measurability", "method", "order", "politicianId", "realm", "source", "status", "statusCheckedAt", "statusNote", "statusSource", "timeline", "title", "updatedAt" FROM "Pledge";
DROP TABLE "Pledge";
