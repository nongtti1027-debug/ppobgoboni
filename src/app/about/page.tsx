      ...
      <div className="space-y-6 text-sm leading-relaxed text-foreground/80">
        ...
        <section id="판정기준">
          ...
          <p className="mt-3">
            ...
            나뉘는 경우, 항목별로 근거를 찾아 채점한 뒤 평균 내 표시합니다: 예산 편성만
            된 경우 20%, 법 제정·조직 신설 등으로 착수됐다면 50%를 기본으로 하고, 그 이후
            실제 집행·시행 기록이 하나씩 추가로 확인될 때마다 조금씩 올려 최종적으로
            목표가 완전히 달성됐을 때만 100%를 부여합니다. &ldquo;육성·확대·강화·전환&rdquo;처럼
            끝이 정해지지 않은 목표는 실적이 아무리 좋아도 100%를 주지 않고, 확인된 실행
            기록의 개수만큼만 착수(50%)보다 조금씩 높게 인정합니다. 근거를 찾지 못한 세부 항목은 &ldquo;미이행(0%)&rdquo;이 아니라
          ...
          <p className="mt-3">
            판정에 이견이 있는 정치인 본인께서 직접 연락해 공약 이행에 대한 소명 자료를
            제시하시면, 확인 후 판정에 반영합니다.
          </p>
        </section>
