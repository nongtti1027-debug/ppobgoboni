    ...
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-foreground/80">
        ...
        <section>
          ...
          <p>
            사이트는 회원가입, 자유게시판 글쓰기·댓글 작성, 정치인 평점 남기기 기능을
            제공합니다. 회원가입 시 이메일 주소, 비밀번호(암호화하여 저장), 닉네임을
            입력받으며, 이는 로그인 및 작성한 게시물·댓글·평점을 계정과 연결하기 위한
            목적으로만 사용됩니다. 비밀번호는 원문이 아닌 암호화된 형태로 저장되어 운영자를
            포함한 누구도 원문을 확인할 수 없습니다.
          </p>
          <p className="mt-2">
            이 외에 서비스 이용 과정에서 아래 정보가 자동으로 생성·수집될 수 있습니다.
          </p>
          <p className="mt-2">
        ...
        <section>
          ...
          <ul className="ml-5 list-disc space-y-1">
            <li>회원 식별 및 로그인, 게시물·댓글·평점 작성자 확인</li>
        ...
        <section>
          ...
          <p>
            회원 정보는 회원 탈퇴 시(탈퇴 요청은 문의 이메일로 접수) 지체 없이 파기합니다.
