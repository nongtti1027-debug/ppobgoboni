...
const judgments: Judgment[] = [
  {
    ...
    progressPercent: 40,
    statusNote:
      "윤석열 전 대통령 내란 우두머리 혐의 1심에서 2026년 2월 무기징역이 선고됐으나 항소심이 진행 중이라 '내란극복' 자체가 아직 사법적으로 확정되지 않았다. 국민통합위원회는 임기를 2030년까지 연장해 5대 갈등 분야 대화를 이어가고 있다. 스웨덴 V-Dem연구소 '민주주의보고서 2026'에서 한국의 민주주의 지수 순위가 41위(2024)에서 22위(2025)로 급등했으나, 이는 정부의 직접 조치라기보다 정치적 안정에 따른 간접 지표에 가깝다. 공약의 핵심 수단인 검찰 수사권 조정에 대해서는 한국갤럽·에이스리서치 등 2026년 7~8월 여론조사에서 '유지해야 한다/폐지는 잘못됐다'는 응답이 50~62%로 우세해, 개혁 방식 자체에 대한 국민 여론은 우호적이지 않다.",
    statusSource:
      "경향신문 - 민주주의지수 41→22위\nhttps://www.khan.co.kr/article/202603172032005\n\n서울경제 - 외국언론의 한국 민주주의 회복력 평가\nhttps://www.sedaily.com/article/20054486\n\n파이낸셜뉴스 - 검찰 수사권 여론조사\nhttps://www.fnnews.com/news/202608141109200905",
  },
  {
    order: 3,
    status: "in_progress",
  ...
  },
  {
    ...
    progressPercent: 40,
    statusNote:
      "2025년 11월 한미 관세·안보 협상이 타결돼 상호관세 15%, 3,500억달러 대미투자, 국방비 GDP 3.5% 증액 등 구체적 수치까지 합의됐다 — '경제안보 구축' 축은 상당히 진전됐다. 그러나 공약의 또 다른 축인 '지속가능한 한반도 평화 실현'은 대북 확성기·전단 살포 중단 등 긴장완화 조치에 그치고, 개성공단 재개나 정상회담 등 실질적 남북관계 개선은 명시적으로 없어 핵심 목표 하나가 사실상 미달성 상태다. 한국갤럽의 '국정 운영 잘한 점' 조사에서 외교는 줄곧 1위로 꼽혀왔지만, 그 응답 비율이 2026년 7월 36%에서 8월 16%까지 계속 낮아지는 추세라 성과에 대한 체감도 역시 약해지고 있다.",
    statusSource:
      "정책브리핑 - 한미 관세·안보 협상 타결\nhttps://www.korea.kr/news/policyNewsView.do?newsId=148954753\n\n통일부 - 한반도 평화공존정책 성과\nhttps://unikorea.go.kr/web/unikorea/bbs/bbs_0000000000000004/59420\n\n경향신문 - 갤럽 국정운영 평가(외교 항목 하락세)\nhttps://www.khan.co.kr/article/202608281025001/",
  },
  {
    order: 5,
    status: "in_progress",
    progressPercent: 52,
    statusNote:
      "정부는 내년부터 5년간 연평균 668명씩 의대 정원을 증원하는 계획을 확정했고 2026년도 수가협상은 8년 만에 전 유형 타결됐다 — 제도 정비는 진전됐다. 그러나 공약이 명시한 '의료 대란 해결'의 핵심인 필수의료 공백은 여전해서, 2026년 상반기 고연차(3·4년차) 전공의 복귀율이 8.7%에 그쳤다. 화재감지기 보급 등 안전 분야 성과는 있었다. 보건의료계 자체 평가에서도 정부 1년 성과를 58.3/100점('보통 수준')으로 평가했다.",
    statusSource:
      "한국일보 - 의대증원 관련 평가\nhttps://www.hankookilbo.com/news/article/A2026071617350005076\n\n정책브리핑 - 화재안전 성과\nhttps://www.korea.kr/news/policyNewsView.do?newsId=148965528\n\n의협신문 - 보건의료 국정과제 1년 평가 58.3점\nhttps://www.doctorsnews.co.kr/news/articleView.html?idxno=165820",
  },
  {
    order: 7,
    status: "in_progress",
