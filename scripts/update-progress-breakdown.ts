...
const pledgeA: Item[] = [
  ...
  },
  {
    item: "R&D 예산 확대",
    percent: 100,
    note: "2026년도 R&D 예산 35조3000억원(전년 대비 19.3%↑, 역대 최대)으로 확정, 국가전략기술·AI·방위산업 등에 배정돼 집행 연도에 진입.",
  ...
  },
  {
    ...
    percent: 100,
    note: "농촌진흥청 스마트농업·그린바이오에 1595억원 투자(2026), K-푸드플러스 수출 2025년 역대 최대(136.3억달러) 달성, 2026년 목표 160억달러로 수출거점 확대 중.",
